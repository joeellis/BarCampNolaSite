...
*   Bryan Davis: Lose The Shoes: How to Untie Yourself From the Norm and Start Running and Thinking Naturally.

Come experience MiniBar on Tuesday, June 7th starts at 6:00pm at Le Chat Noir (715 St Charles Avenue).  \---|\-- -|\---|- BarCampNola is back! 

### BarCampNola is back!

The dates have just been announced, BarCampNola 4 is taking place on July 16th and 17th.  
...
> - NewOrleansTech.Net 
A BIG thank you to all of our BarCampNola 4 [sponsors][1] who helped us make this possible!  \---|-- What is BarCampNola? 

## What is BarCampNola?

BarCampNola is a local incarnation of the international network of user generated conferences called <a href="http://barcamp.org/w/page/402984/FrontPage" target="_blank">BarCamps</a>.  
  
BarCamp is an ad-hoc gathering born from the desire for people to share and learn in an open environment. It is an intense event with discussions, demos, and interaction from attendees. It is an open event where each attendee is encouraged to participate and present. All content comes from the attendees and each workshop or presentation is scheduled on the day of the event, differentiating it from 'regular' conferences.  
...
Checkout this great review of last year's event from our friends at <a href="http://neworleanstech.net/2010/07/editorial-an-inside-look-at-barcamp-nola-3/" target="_blank">NewOrleansTech.net</a>  
  


If you are new to BarCamp, check out the BarCamp basics links below:   
...
*   11:00 - 1:00 : First Round of Presentations
*   12:59 : Soslow arrives for free lunch
...
To register, click on the link above and add yourself to the open google doc.  
...
Option 3: $6 a day parking in the lot at the corner of Magazine and St. Joseph \---|-- Locations Right 
...
If you are interested in supporting BarCampNola please drop us a mail at barcampnola (at) gmail (dot) com.  
  


## Why Sponsor BarCampNola?

BarCampNola is a **FREE** event supported entirely by sponsorships. Sponsorships will go towards providing breakfast, lunch and snacks for both days of the event as well as provide general support and t-shirts for the attendees. According to BarCamp's international guidelines a company can donate a max of $300. Despite the hardship or organizing an event at such low sponsorship levels, we are proud to be one of the few BarCamps to maintain this tradition.  
  
As a sponsor you will be recognized in the following ways:  


*   Sponsor-supplied profile on website
*   Logo on T-Shirt
...
Check out the <a href="http://www.gatorworks.net/art/live-blog-barcamp-nola-2009" target="_blank">live blog</a> from that day maintained by one of our sponsors GatorWorks.

GatorWorks also stepped up and offered to host the new site, and pay for the domain registration.

#### Planning Wiki

We used the following <a href="http://ryandlane.com/sandbox/Wordpress_info" target="_blank">wiki</a> to keep our efforts organized throughout the day.

It was an invaluable scrib sheet for our ideas and brainstorming efforts, provided by Ryan Lane.

#### Open Issues

We are keeping track of open issues from day two on <a target="_blank" href="http://ryandlane.com/wprdl/2009/07/20/bug-tracking-post-for-nolaschoolvolunteers-org/">Ryan Lane's blog.</a>

#### The Team

And last but not definitly not least, the list of all team members and a picture from that day can be found on the <a href="http://www.nolaschoolvolunteers.org/2009/07/19/barcampnola/" target="_blank">volunteer site</a> itself.
...
There is no summary of the event available but Chris did put together this video:  
 ...
 [3]: http://farm3.static.flickr.com/2430/3739350831_8a1c864e10.jpg
 [4]: http://farm3.static.flickr.com/2535/3740178446_54e6b3431c.jpg
 [5]: http://www.slideshare.net/jwthompson2/ruby-testing-cucumber-and-rspec